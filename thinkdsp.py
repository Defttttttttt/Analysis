...
class WavFileWriter:
    ...
    def __init__(self, filename='sound.wav', framerate=1024):#original,11025
...
class Spectrum(_SpectrumParent):
    ...
    def angles(self):
        ...
        return np.angle(self.hs,deg=1)  #add deg=1
...
class Wave:
    ...
    def __init__(self, ys, ts=None, framerate=None):
        ...
        self.framerate = framerate if framerate is not None else 1024  #11025
...
class Signal:
    ...
    def plot(self, framerate=1024): #11025
        """Plots the signal.
    ...
    def make_wave(self, duration=1, start=0, framerate=1024): #11025
        """Makes a Wave object.
...
def make_note(midi_num, duration, sig_cons=CosSignal, framerate=1025): #11025
...
def make_chord(midi_nums, duration, sig_cons=CosSignal, framerate=1024): #11025
